...
Amazon Scraper is an open-source project that aims to **scrape data from Amazon** and other e-commerce websites. It is built using the **Scrapy framework** and **Python** and is designed to be used for **price comparison** and **product research purposes**.
...
Amazon Scraper **can be used as an API service** to scrape data from **Amazon and other e-commerce websites** and you can also **export the data in a json format** if required.
...
If you are interested in contributing to Amazon Scraper, please follow these guidelines:
...
## License
Amazon Scraper is licensed under the GNU General Public License v3.0. This means that you are free to use, modify, and distribute the code as long as you adhere to the terms of the license.

## Contact
If you have any questions or feedback, please feel free to reach out to me at srswarup_b21@ce.vjti.ac.in

Thank you for using Amazon Scraper!
